...
const SAMPLE_NODES = [
  ...
  { id: "node-gemini-1", type: "gemini", position: { x: 340, y: 60 }, data: { label: "Gemini 3.1 Pro #1", model: "gemini-1.5-pro", prompt: "", systemPrompt: "You are a marketing copywriter. Write a one-paragraph product description." } },
  { id: "node-gemini-2", type: "gemini", position: { x: 660, y: 60 }, data: { label: "Gemini 3.1 Pro #2", model: "gemini-1.5-pro", prompt: "", systemPrompt: "Condense the following product description into a tweet-length hook (under 240 characters)." } },
  { id: "node-gemini-3", type: "gemini", position: { x: 900, y: 200 }, data: { label: "Gemini 3.1 Pro #3 (Final)", model: "gemini-1.5-pro", prompt: "", systemPrompt: "You are a social media manager. Combine the tweet hook and the two product crops into a final marketing post." } },
